...
| ------- | ------- | ------- | ------- |
| **borrower_name** | *string* | Name of borrower company. NOTE: this field is currently part of another API and is not illustrated on request examples below| "Borrower LLC" |
